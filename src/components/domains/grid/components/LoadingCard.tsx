...
const LoadingCard = ({ ref }: { ref?: RefObject<HTMLDivElement> }) => {
  return (
    <div className={`group flex flex-1 cursor-pointer flex-col gap-y-px`} ref={ref}>
      <div className={`gradient-gray flex h-[170px] w-full flex-col justify-between p-[21px]`} />
