...
// import { useClubActivity } from '../hooks/useActivity'
...
// const ActivityPanel: React.FC<Props> = ({ club }) => {
//   const dispatch = useAppDispatch()
//   const { selectors, actions } = useFilterRouter()
//   const { activity, activityLoading, fetchMoreActivity, hasMoreActivity } = useClubActivity(club)
