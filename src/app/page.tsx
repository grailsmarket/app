...
const Home = () => {
  return (
    <main className='relative max-w-screen overflow-hidden'>
      <div className='z-10 mx-auto flex h-full w-full max-w-[1296px] flex-col items-center gap-4 md:gap-12 px-4 pt-14 md:px-8 lg:pt-8 xl:px-4'>
        <AnimateIn className='flex w-full flex-col items-center justify-center lg:flex-row lg:items-start lg:justify-start xl:gap-0'>
        ...
        <DisplayedCards />
        <div className='flex flex-col items-center justify-center gap-12 sm:gap-20 md:gap-28 max-w-full'>
          <RecentContainer />
          <BulkTools />
          <TopCategories />
          <TwitterBot />
