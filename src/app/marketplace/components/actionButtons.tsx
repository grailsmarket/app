  ...
  return (
    <>
      <button
        onClick={scrollToTop}
        className={cn(
          'bg-secondary hover:bg-tertiary border-tertiary fixed right-2 z-10 flex h-11 w-11 cursor-pointer items-center justify-center rounded-md border-2 shadow-sm transition-all duration-300 @[48rem]/app:right-4 @[80rem]/app:right-5',
      ...
      <div
        className={cn(
          'border-tertiary action-buttons-container bg-background fixed bottom-0 left-0 z-40 flex h-14 w-full flex-row items-center justify-end rounded-b-lg border-t-2 transition-all duration-300 @[48rem]/app:h-16 starting:translate-y-full',
