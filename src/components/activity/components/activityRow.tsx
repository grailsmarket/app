...
const ActivityRow: React.FC<ActivityRowProps> = ({ activity, displayedColumns, displayedAddress, index }) => {
  ...
  return (
    <div className='group px-md @[64rem]/app:px-lg border-tertiary flex h-[86px] w-full max-w-full flex-row flex-wrap items-center justify-start border-b bg-transparent py-1 transition hover:bg-white/10 @[40rem]/app:h-[60px] @[40rem]/app:flex-nowrap @[40rem]/app:py-0'>
      ...
      {displayedColumns.includes('name') ? (
        <div className='pr-md flex w-full flex-row justify-between @[40rem]/app:hidden'>
          {addressToShow && (
            <User
