    ...
    <FilterProvider filterType='marketplace'>
      <main className='relative md:px-4'>
        ...
        <div className='relative z-10 mx-auto flex w-full flex-col gap-32 pt-24'>
          <div className='px-lg lg:p-lg max-w-domain-panel bg-background border-primary relative mx-auto flex h-[calc(100vh-96px)] w-full flex-row gap-4 overflow-hidden rounded-t-sm border-t-2 md:h-[90vh] md:rounded-lg md:border-2'>
            <FilterPanel />
            <DomainPanel />
            <ActionButtons />
          </div>
