...
const ProCta = () => {
  ...
  return (
    <section className='relative flex w-full flex-col items-center gap-6 overflow-hidden rounded-2xl border-2 border-primary/20 px-6 py-16 text-center sm:py-20 md:py-24'>
      ...
      >
        ...
        <div className='mt-2 flex flex-col items-center gap-4 sm:flex-row'>
          ...
          <button
            ...
            className='border-tertiary hover:border-white/40 cursor-pointer rounded-sm border-2 px-8 py-3.5 text-lg font-semibold transition-colors'
          >
            Start with Plus
          </button>
        </div>
        <p className='text-neutral/60 text-sm'>Cancel anytime. No hidden fees.</p>
      </motion.div>
    </section>
  )
}
