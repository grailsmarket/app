...
const GlobalSearchModal: React.FC<GlobalSearchModalProps> = ({ isOpen, onClose, initialQuery = '' }) => {
  ...
  return (
    <div
      className='fixed top-0 right-0 bottom-0 left-0 z-[100] flex h-screen w-screen items-start xl:items-center justify-center overflow-scroll bg-black/50 px-2 py-12 backdrop-blur-sm'
      onClick={handleClose}
    >
      <div
