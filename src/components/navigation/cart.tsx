...
const Cart = () => {
  ...
  return (
    ...
    >
      ...
      {totalCartItems > 0 && (
        <div className='text-background bg-primary md:text-md absolute -top-2 -right-2 flex h-4 w-fit min-w-4 items-center justify-center rounded-full px-1 text-sm font-bold sm:h-5 sm:min-w-5 md:-top-2 md:-right-2 md:h-5 md:min-w-5'>
          {totalCartItems}
        </div>
      )}
    </button>
