...
const Register: React.FC<RegisterProps> = ({ nameDetails, registrationStatus }) => {
  ...
  if (registrationStatus === GRACE_PERIOD) {
    ...
    return (
      <div className='p-lg lg:p-xl bg-secondary flex w-full flex-col gap-6 sm:rounded-lg sm:border-2 sm:border-tertiary'>
  ...
  if (registrationStatus === PREMIUM) {
    ...
    return (
      <div className='p-lg lg:p-xl bg-secondary flex w-full flex-col gap-4 sm:rounded-lg sm:border-2 sm:border-tertiary'>
