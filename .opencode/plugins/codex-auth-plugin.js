...
const MODEL_COSTS = {
  "gpt-5.1-codex-max":   { input: 5.00, output: 15.00, cache: { read: 0.50, write: 6.25 } },
  "gpt-5.1-codex-mini":  { input: 0.25, output: 1.00,  cache: { read: 0.03, write: 0.30 } },
  "gpt-5.1-codex":       { input: 2.50, output: 10.00, cache: { read: 0.25, write: 3.00 } },
  "gpt-5.2":             { input: 3.00, output: 12.00, cache: { read: 0.30, write: 3.75 } },
  "gpt-5.2-codex":       { input: 3.00, output: 12.00, cache: { read: 0.30, write: 3.75 } },
  "gpt-5.3-codex":       { input: 4.00, output: 14.00, cache: { read: 0.40, write: 5.00 } },
  "gpt-5.3-codex-spark": { input: 1.50, output: 6.00,  cache: { read: 0.15, write: 1.80 } },
  "gpt-5.4":             { input: 6.00, output: 18.00, cache: { read: 0.60, write: 7.50 } },
  "gpt-5.5":             { input: 8.00, output: 24.00, cache: { read: 0.80, write: 10.00 } },
};
      ...
      async loader(getAuth, provider) {
        ...
        if (!provider.models["gpt-5.3-codex"]) {
          provider.models["gpt-5.3-codex"] = {
            ...
            cost: MODEL_COSTS["gpt-5.3-codex"],
          };
        }
        ...
        if (!provider.models["gpt-5.3-codex-spark"]) {
          provider.models["gpt-5.3-codex-spark"] = {
            ...
            variants: {},
            limit: { context: 1000000, output: 1000000 },
            cost: MODEL_COSTS["gpt-5.3-codex-spark"],
          };
        }

        for (const [modelId, model] of Object.entries(provider.models)) {
          model.cost = MODEL_COSTS[modelId] ?? { ...DEFAULT_COST };
        }
