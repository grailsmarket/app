...
import { selectProfileActivityFilters, toggleActivityFiltersType } from '@/state/reducers/filters/profileActivityFilters'
      ...
      >
        <div className="w-full mb-6">
          <div className="flex w-full flex-col gap-3">
            <p className="text-lg font-medium leading-[18px]">Type</p>
          </div>
        </div>
