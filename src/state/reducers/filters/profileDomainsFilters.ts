...
export const profileDomainsFiltersSlice = createSlice({
  ...
  reducers: {
    ...
    setProfileDomainsTextMatchFilters(state, { payload }: PayloadAction<TextMatchFiltersState>) {
      state.textMatch = payload
    },
    setProfileDomainsTextNonMatchFilters(state, { payload }: PayloadAction<TextNonMatchFiltersState>) {
