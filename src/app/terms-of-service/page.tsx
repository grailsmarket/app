    ...
    <>
      <main className='mx-auto flex max-w-4xl flex-col items-center gap-6 py-8 font-medium'>
        ...
        <div className='flex w-full flex-col gap-1'>
          ...
          <p>
            Grails relies on third-party infrastructure and protocols, including Ethereum, ENS, wallet providers, and
            RPC services. We do not control and are not responsible for their operation.
          </p>
        </div>
        ...
        <div className='flex w-full flex-col gap-1'>
          ...
          <p>
            Any dispute arising out of or relating to Grails or these Terms shall be resolved through binding
            arbitration, except that either party may seek injunctive or equitable relief in court.
          </p>
