  ...
  return (
    ...
    >
      <div className='flex w-[45%] max-w-[45%] flex-row items-center gap-2'>
        ...
        <NameImage name={listing.name} tokenId='' expiryDate={null} forceRegStatus={REGISTERED} className='h-8 w-8 shrink-0 rounded-sm' />
  ...
  return (
    ...
    >
      <div className='flex w-[45%] flex-row items-center gap-2'>
        ...
        <NameImage name={offer.name} tokenId='' expiryDate={null} forceRegStatus={REGISTERED} className='h-8 w-8 shrink-0 rounded-sm' />
  ...
  return (
    ...
    >
      <div className={cn('flex flex-row items-center gap-2', hideSeller ? 'w-[50%]' : 'w-[40%]')}>
        ...
        <NameImage name={sale.name} tokenId='' expiryDate={null} forceRegStatus={REGISTERED} className='h-8 w-8 shrink-0 rounded-sm' />
        <div className='w-full max-w-[calc(100%-60px)] truncate'>
  ...
  return (
    ...
    >
      <div className='flex w-[45%] flex-row items-center gap-2'>
        ...
        <NameImage name={registration.name} tokenId='' forceRegStatus={REGISTERED} expiryDate={null} className='h-8 w-8 shrink-0 rounded-sm' />
