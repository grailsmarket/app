    ...
    <Suspense>
      <FilterProvider filterType='portfolio' portfolioTab={selectedTab.value}>
        <main className='relative'>
          ...
          <div className='relative z-10 mx-auto flex w-full flex-col gap-32 pt-16 md:pt-20'>
            <div className='bg-background relative mx-auto flex h-[calc(100dvh-62px)] w-full flex-row overflow-hidden md:h-[calc(100dvh-80px)] lg:pl-2'>
              <FilterPanel />
