...
const DisplayedCards: React.FC = () => {
  ...
  return (
    <div className='shadow-primary background-radial-primary relative mt-28 h-[280px] w-[240px] rounded-full sm:mt-24 lg:mt-40'>
      <div className='shadow-homeCard absolute -top-28 left-0 z-20 h-[360px] w-[190px] overflow-hidden rounded-lg sm:-top-24 sm:left-0 sm:h-[410px] sm:w-[240px]'>
        {isLoading || !domains ? (
          <LoadingCard />
        ) : (
      ...
      <div className='shadow-homeCard absolute top-0 left-28 z-30 h-[360px] w-[190px] overflow-hidden rounded-lg sm:top-0 sm:left-36 sm:h-[410px] sm:w-[240px]'>
        {isLoading || !domains ? (
          <LoadingCard />
        ) : (
      ...
      <div className='shadow-homeCard absolute top-14 -left-12 z-10 h-[360px] w-[190px] overflow-hidden rounded-lg sm:top-24 sm:-left-20 sm:h-[410px] sm:w-[240px]'>
        {isLoading || !domains ? (
          <LoadingCard />
        ) : (
