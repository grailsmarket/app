...
const Navigation = ({ showInfo }: { showInfo: boolean }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          'p-lg pt-lg md:p-xl border-tertiary bg-background/80 absolute top-14 left-0 -z-10 flex h-[calc(100dvh-56px)] w-full flex-col justify-between gap-4 overflow-y-scroll border-b-2 backdrop-blur-md transition-all duration-500 ease-out md:top-16 md:z-0 md:h-fit md:shadow-md md:duration-350',
