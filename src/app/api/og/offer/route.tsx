...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const [ownerProfile, offerrerProfile, ensSVG, categoryAvatars] = await Promise.all([
      getOwnerProfile(),
      getOfferrerProfile(),
      getENSSVG(),
        ...
        <head>
          ...
          <style>
            * { margin: 0; padding: 0; box-sizing: border-box; }
            svg text, svg tspan { font-family: 'Inter', system-ui, -apple-system, sans-serif, 'Noto Color Emoji' !important; font-variant-emoji: unicode; }
            body {
              width: ${size.width}px;
