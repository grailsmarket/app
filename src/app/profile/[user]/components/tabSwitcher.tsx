...
const TabSwitcher: React.FC<TabSwitcherProps> = ({ user }) => {
  ...
  if (!mounted) {
    return (
      <div
        className={cn(
          'bg-background pr-lg border-tertiary text-md sticky z-20 flex min-h-12 items-center gap-2 border-b-2 transition-[top] duration-300 @[26.25rem]/app:gap-4 @[26.25rem]/app:text-lg @[40rem]/app:pr-0 @[40rem]/app:text-xl @[48rem]/app:min-h-14 @[64rem]/app:gap-8',
