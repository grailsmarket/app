        ...
        {success ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-2">
                <button
                  ...
                  className={`px-3 py-2 border rounded-md transition-colors ${selectedMarketplace === 'grails'
                ...
                <button
                  ...
                  className={`px-3 py-2 border rounded-md transition-colors ${selectedMarketplace === 'opensea'
                    ? 'border-purple-500 bg-purple-500/20 text-purple-400'
                    : 'border-gray-700 hover:bg-gray-800'
                    }`}
                >
                ...
                <button
                  ...
                  className={`px-3 py-2 border rounded-md transition-colors ${selectedMarketplace === 'both'
                    ? 'border-purple-500 bg-purple-500/20 text-purple-400'
                    : 'border-gray-700 hover:bg-gray-800'
                    }`}
                >
            ...
            <div className="flex gap-3">
              ...
              >
                {isLoading ? 'Creating...' : `List on ${selectedMarketplace === 'both' ? 'Both' :
