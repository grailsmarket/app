...
const OfferRow: React.FC<OfferRowProps> = ({ offer, displayedColumns, currentUserAddress, index }) => {
  ...
  return (
    <div className='group px-md border-tertiary @[64rem]/app:px-lg flex h-[60px] w-full flex-row items-center justify-between gap-1 border-b bg-transparent transition hover:bg-white/10'>
