...
const ChannelSelect: React.FC<ChannelSelectProps> = ({ handleDropdownChange, selectedOption, filterCategories }) => {
  ...
  return (
    <div className='z-20 px-4 pt-4'>
      <Dropdown
        searchable
        options={[{ label: 'Global Chat', value: 'global' }, ...formattedFilterCategories]}
