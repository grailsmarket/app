...
const Navigation = () => {
  return (
    <header className='bg-background border-tertiary fixed top-0 left-[50%] z-50 mx-auto h-16 w-full max-w-[2340px] -translate-x-1/2 border-b-2 app:border-r-2 app:border-l-2 backdrop-blur-md md:h-20'>
